...
import { kilnPhotos } from "./kilnPhotos";
...
function KilnSite({
  ...
  const c = COPY[locale]["kiln-identity"];
  const { pageId, setPageId } = useSitePage(c.homeId, mode);

  return (
    <BrowserShell url={urlFor(c.host, pageId)} accent={accent} mode={mode}>
      <div className="live-kiln">
        <SiteNav brand={c.brand} pages={c.pages} pageId={pageId} onNavigate={setPageId} />

        {pageId === "home" && (
          <>
            <section className="live-kiln__hero">
              <img className="live-img" src={kilnPhotos.workshop} alt="Workshop" loading="lazy" />
              <div className="live-kiln__hero-copy">
                <p className="live-kicker">{c.extras.kicker}</p>
                <h1 className="live-h1">{c.headlines.home}</h1>
                <p className="live-lead">{c.leads.home}</p>
                <div className="live-ctas">
            ...
            <div className="live-gallery">
              <figure>
                <img className="live-img" src={kilnPhotos.copper} alt="Copper" loading="lazy" />
                <figcaption>{c.extras.project1}</figcaption>
              </figure>
              <figure>
                <img className="live-img" src={kilnPhotos.pottery} alt="Pottery" loading="lazy" />
                <figcaption>{c.extras.project2}</figcaption>
              </figure>
              <figure>
                <img className="live-img" src={kilnPhotos.tools} alt="Forge" loading="lazy" />
                <figcaption>{c.extras.project3}</figcaption>
              </figure>
            </div>
          </>
        )}
        ...
        {pageId === "work" && (
          <div className="live-pad">
            <p className="live-kicker">Work</p>
            <h1 className="live-h1">{c.headlines.work}</h1>
            <p className="live-lead">{c.leads.work}</p>
            <div className="live-gallery" style={{ padding: 0 }}>
              {[
                kilnPhotos.copper,
                kilnPhotos.pottery,
                kilnPhotos.workshop,
                ...
                kilnPhotos.copper,
                  ...
                  <figure key={i}>
                    <img className="live-img" src={src} alt={`Project ${i + 1}`} loading="lazy" />
                    <figcaption>Piece 0{i + 1}</figcaption>
                  </figure>
                ),
              )}
            </div>
        ...
        {pageId === "process" && (
          <div className="live-pad">
            <p className="live-kicker">Process</p>
            <h1 className="live-h1">{c.headlines.process}</h1>
            <p className="live-lead">{c.leads.process}</p>
            <div className="live-steps" style={{ padding: 0 }}>
              {[c.extras.step1, c.extras.step2, c.extras.step3].map((step, i) => (
            ...
            <div style={{ marginTop: 12, borderRadius: 8, overflow: "hidden", minHeight: 100 }}>
              <img className="live-img" src={kilnPhotos.tools} alt="Process tools" loading="lazy" />
            </div>
          </div>
        )}
        ...
        {pageId === "contact" && (
          <div className="live-pad">
            <p className="live-kicker">Contact</p>
            <h1 className="live-h1">{c.headlines.contact}</h1>
            <p className="live-lead">{c.leads.contact}</p>
            <p style={{ fontSize: 10, color: "var(--live-a)", marginBottom: 8 }}>{c.extras.hours}</p>
            <div className="live-person">
              <img className="live-avatar" src={kilnPhotos.portrait} alt="" loading="lazy" />
              Rhea Holt · Atelier lead
            </div>
            <div className="live-ctas" style={{ marginTop: 12 }}>
              <button type="button" className="live-btn">
                {c.ctas.contact}
            ...
            <div style={{ marginTop: 12, borderRadius: 8, overflow: "hidden", minHeight: 90 }}>
              <img className="live-img" src={kilnPhotos.copper} alt="Studio copper" loading="lazy" />
            </div>
          </div>
        )}

        <footer className="live-footer">Kiln Atelier — portfolio case</footer>
      </div>
    </BrowserShell>
  );
}
