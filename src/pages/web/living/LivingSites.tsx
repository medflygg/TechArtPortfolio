  ...
  ru: {
    "aurora-flute": {
      ...
      headlines: {
        ...
        product: "Один интерфейс для private wealth.",
        security: "Стеклянные стены. Стальные замки.",
        pricing: "Тарифы без лишнего шума.",
        about: "Сделано операторами, не хайпом.",
      },
      leads: {
        home: "Премиальный finance-интерфейс: рифлёное стекло, мягкая рефракция и CTA, от которых трудно уйти.",
        product: "Переводы, сейфы и доход в одном языке контролов — одни токены рефракции на каждой панели.",
        security: "Ключи на железе, двойное подтверждение и аудиты, которые можно читать.",
        pricing: "Экономика private banking без мраморного лобби. Начните с малого — растите вместе с командой.",
    ...
    "mirage-deck": {
      ...
      headlines: {
        ...
        market: "Цена пола без лишнего шума.",
        vault: "Коллекция под печатью.",
        about: "Сезонный крафт, не спам-дропы.",
      },
      leads: {
        drop: "Переливные коллекционные карты с бликом при наклоне, моментами раскрытия и кинематографичным маркетом.",
        market: "Живые лоты с foil-грейдами и метками последней продажи — удобно кропать для шаринга.",
    ...
    "prism-controls": {
      ...
      headlines: {
        ...
        states: "Покой → Наведение → Armed → Готово.",
        customers: "Команды с тихим UI.",
        pricing: "Одна матрица. Любая поверхность.",
      },
      leads: {
        product: "Язык SaaS-контролов — idle, hover, armed, confirmed — без лишнего хрома.",
        states: "Кликайте по матрице. Armed и confirmed читаются светом, а не лишними подписями.",
        customers: "Продуктовые команды с одним токен-файлом между Figma и продакшеном.",
        pricing: "Бесплатно на маркетинге. В тулбары — без редизайна.",
      },
      ctas: {
        primary: "Начать",
        secondary: "Демо",
    ...
    northline: {
      ...
      leads: {
        journal: "Редакционная идентичность research-студии — крупный display-шрифт, тонкие линии, спокойный цвет.",
        study: "Как ограничение становится активом бренда, когда у каждой страницы одна сетка.",
        index: "Эссе, исследования и заметки на полях — с Vol. 01 по Vol. 12.",
    ...
    "folio-os": {
      ...
      headlines: {
        ...
        modules: "Сборный UI без потери характера.",
        security: "SSO, аудит и тихий compliance.",
        pricing: "Места, которые растут вместе с командой.",
      },
      leads: {
        overview: "B2B-система, которая объединяет скины, не выравнивая характер — сначала токены, потом модули.",
        modules: "Навигация, таблицы, тосты и поля ввода делят одни interaction-примитивы.",
        security: "Ролевые экраны с экспортируемыми логами — для передачи, не для театра.",
        pricing: "Тарифы за место с общими токенами для Design, Ops и Docs.",
      },
      ctas: {
    ...
    "kiln-identity": {
      ...
      leads: {
        home: "Тёплая industrial-идентичность мастерской — сайт продолжает сетку постеров.",
        work: "Железо, печати и пространственные знаки для ателье, которые ещё касаются металла.",
        process: "Фото и типографика делят те же поля, что и печатная серия.",
        contact: "Расскажите о задаче. Ответим за два рабочих дня студии.",
      },
      ctas: {
        primary: "Комиссия",
        secondary: "Студия",
    ...
    "orbit-drop": {
      ...
      leads: {
        home: "Страница запуска с сильной подачей — кинематографичный герой, два CTA, метрики вне шума первого экрана.",
        story: "Начали с одной композиции и отказались от свалки feature-карточек ниже первого экрана.",
        specs: "Тип, свечение и иерархия CTA как одна система — проверено на mid-tier ноутбуках.",
        access: "Сначала invite. Публичный waitlist — когда освободится инвентарь.",
      },
      ctas: {
    ...
    "signal-release": {
      ...
      leads: {
        chapters: "Посадочная по главам: сложный дроп объясняется без стены карточек.",
    ...
    "vault-access": {
      ...
      leads: {
        invite: "Лист ожидания, который ощущается как приглашение — тихая срочность, без фейковых таймеров.",
        members: "Основатели, коллекционеры и редакторы, которые предпочитают письма громким запускам.",
