...
const COPY = {
  en: {
    ...
    thumbTag: "Bespoke fragrance · Atmosphere · Sound",
  },
  ru: {
    brand: "ÉTHER",
    host: "ether.studio",
    ...
    revealBody: "Собрана только из этого путешествия. Визуал остаётся абстрактным — сам продукт это аромат.",
    ...
    done: "Заявка принята — скоро напишем.",
    mute: "Выкл. звук",
    muted: "Вкл. звук",
    ...
    ship: "Город",
    memory: "Ваш бриф",
    memorySub: "Места и ноты, которые вы исследовали — старт для аромата на заказ.",
    thumbTag: "Аромат на заказ · Атмосфера · Звук",
  },
} as const;
